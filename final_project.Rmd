...
```{r}
y_m <- 5e4
alphas <- c(0.5) #true values of alpha. You can try other values too.
num_alphas <- length(alphas)
ns <- c(5, 10, 15, 20, 25, 50, 100) # sample sizes. You can try other values too.
num_ns <- length(ns)
numIter <- 100 # number of simulationsX
